...
namespace neon
{
    Neon777AudioProcessor::Neon777AudioProcessor()
        : AudioProcessor (BusesProperties().withOutput ("Output", juce::AudioChannelSet::stereo(), true))
    {
        PatchManager::getInstance().initialize ("Neon777");
    ...
    void Neon777AudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
    {
        signalPath.prepareToPlay (samplesPerBlock, sampleRate);
    }

    void Neon777AudioProcessor::releaseResources()
    {
        signalPath.releaseResources();
    }

    void Neon777AudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
    {
    ...
    juce::AudioProcessorEditor* Neon777AudioProcessor::createEditor()
    {
        return new Neon777AudioProcessorEditor (*this);
    }
} // namespace neon

juce::AudioProcessor* JUCE_CALLTYPE createPluginFilter()
{
    return new neon::Neon777AudioProcessor();
}
